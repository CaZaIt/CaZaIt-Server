...
public class FavoritesApiController {
    ...
    public SuccessResponse<FavoritesCreateOutDTO> addFavorites(@PathVariable UUID userId, @PathVariable UUID cafeId)
    ...
    public SuccessResponse<String> deleteFavorites(@PathVariable UUID userId, @PathVariable UUID cafeId) {
