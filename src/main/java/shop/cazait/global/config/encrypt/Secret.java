...
public class Secret {
	public static String MASTER_INFO_PASSWORD_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiTWFzdGVyIn0.Sw6L6Kv_Hf_-f5tKPMZjXGAVACU6daIRNBIyVuYmo2o";
